...
- Most likely implementation targets:
  ...
  - File/module family: add ./workforce_api/apps/api/app/api/v1/endpoints/bootstrap.py (endpoint: GET /api/v1/bootstrap or /api/v1/session) [NEEDS VERIFICATION - bootstrap endpoint not found]
